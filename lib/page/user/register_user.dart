  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      children: [
        Positioned.fill(
          child: Padding(
            padding: EdgeInsets.only(bottom: screenSize.height * 0.750),
            child: Container(
              decoration: const BoxDecoration(
                color: Color.fromARGB(255, 247, 182, 254),
              ),
              child: const Padding(
                padding: EdgeInsets.only(bottom: 50, left: 100, top: 100),
                child: SizedBox(
                  child: Text(
                    "ลงทะเบียนผู้ใช้",
                    style: TextStyle(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      SizedBox(
                        width: screenSize.width * 0.6, // ขยายความกว้างของ Card
